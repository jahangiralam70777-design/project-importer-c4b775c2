...
export function StatCard({
  ...
  return (
    <div className="glass shadow-card-soft group relative overflow-hidden rounded-2xl p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-glow sm:p-5">
      <div
        className={cn(
      ...
      <div className="relative flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-2 font-display text-2xl font-bold tabular-nums tracking-tight sm:text-[1.75rem]">
            {value}
          </p>
